...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/postRegistration.css">
...
<body>
	...
	<div class="row">
		...
		<div id="center-registration" class="col-6 col-s-9">
			<h2 class="center-registration">Update Aadhaar Number & Secret
				PIN</h2>
			<p>
				To make your account secure, you need to provide the aadhaar number
				along with a secret pin that will be used to verify your
				authenticity under certain steps. <br />
			<div>
				<div>
					<div>
						<form action="/app/post-registration" method="post"
							...
							<div>
								<input id="username" type="text" minlength="6" maxlength="10"
									name="username" placeholder="Username" /> <input
									id="aadhaarNo" type="number" name="aadhaarNo"
									placeholder="Aadhaar Number" />
							</div>
							<div>
								<input id="secretPin" type="number" name="secretPin"
