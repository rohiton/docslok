...
<body>
	...
	<div class="row">
		...
		<div id="center-registration" class="col-6 col-s-9">
			...
			<p class="center-registration">Provide a few information about
				yourself to get started with your docslok account</p>
			<br />
			<div>
				<div>
					<div>
						<form action="/app/registration" method="post"
							...
							<div>
								<input id="firstName" minlength=3 maxlength=10 type="text"
									name="firstName" placeholder="Firstname" /> <input minlength=3
									maxlength=10 id="lastName" type="text" name="lastName"
									placeholder="Lastname" />
							</div>
							<div>
								<input id="email" type="email" name="email" placeholder="Email" />
								<input id="username" type="text" minlength=5 maxlength=10
									name="username" placeholder="Username" />
							</div>
							<div>
								<input id="password" minlength=6 maxlength=10 type="password"
									name="password" placeholder="Password" />
								<p>
									<input id="accept-checkbox" type="checkbox"
										name="accept-checkbox" />I want to create an account
								</p>
							</div>
