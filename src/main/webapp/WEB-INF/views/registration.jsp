...
<div id="registration-parent" class="col-6 col-s-9">
		<h1 class="registration-parent">Register on docslok</h1><br/>
					...
					<form action="/app/register" method="post">
						...
						<div>
							<input id="input" type="password" name="password"
								...
								<p><input id="terms-accept" type="checkbox" name="terms" />Accept terms and conditions</p>
						</div>

						<div>
							<button id="registration-button" class="registration-button" name="Register" type="Submit">Register</button>
						</div>
