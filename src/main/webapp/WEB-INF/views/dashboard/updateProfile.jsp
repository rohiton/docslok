...
<link
	...
	rel="stylesheet">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/dashboard/updateProfile.css">
			...
			<form method="POST" action="/app/dashboard/update-profile">
				<table>
					<tr>
						...
						<input type="number" name="userId" disabled value="${user.userId}"></td>
					</tr>
					<tr>
						<td><label>Aadhaar Number</label><br />
						<input type="number" name="aadhaarNo" disabled
							value="${user.aadhaarNo}" /></td>
					</tr>
					<tr>
						<td><label>Account Status</label><br />
						<input type="text" name="accountStatus" disabled
							value="${user.accountStatus}" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<input type="text" name="email" disabled value="${user.email}" /></td>
					</tr>
					<tr>
						<td><label>Secret Pin</label><br />
						<input type="number" name="secretPin" value="${user.secretPin}" /></td>
					</tr>
					<tr>
						<td><input style="margin-top: 26px;" type="submit"
							name="submit" value="Update Profile"></td>
					</tr>
				</table>
				<p>* You can only change your firstname, lastname and secret pin</p>
				<p>
					* For additional help, raise a ticket <a
						href="/app/dashboard/manage-account/raise-ticket">here</a>
				</p>
			</form>
		</div>
