...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/dashboard/issuedDocuments.css">
<title>Issued Documents</title>
</head>
<body>
	...
	<div id="center-login" class="col-6 col-s-9">
		<h1 class="center-login">Issued Documents</h1>
	</div>
